...
L["If checked, a group invite will be sent to anyone who whispers you with the keyword INV.|n|nYou need to be either ungrouped or party leader in your own group for this to work."] = "Wenn ausgewählt, wird eine Gruppeneinladung an jeden ausgeschickt der dich mit dem Stichwort INV anflüstert."
