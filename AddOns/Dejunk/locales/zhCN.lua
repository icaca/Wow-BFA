...
L["AUTO_OPEN_DESTROY_SLIDER_LABEL"] = "保留空间"
L["AUTO_OPEN_DESTROY_SLIDER_TOOLTIP"] = "仅当背包剩余空间小于设定值时自动打开摧毁框架。|n|n将滑动条设为%s以禁用此项。"
L["AUTO_OPEN_DESTROY_TEXT"] = "自动打开"
