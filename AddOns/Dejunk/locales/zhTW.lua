...
L["AUTO_DESTROY_SLIDER_LABEL"] = "節省空間"
L["AUTO_DESTROY_SLIDER_TOOLTIP"] = "僅在剩餘的背包空格少於設置的數量時自動摧毀物品。|n|n要停用此功能，請滑動條設置為％s。"
...
L["CLASS_TEXT"] = "職業"
L["CMD_HELP_DESTROY"] = "開始摧毀物品。"
L["CMD_HELP_OPEN"] = "開始開啟戰利品。"
L["CMD_HELP_SELL"] = "開始出售物品。"
L["CMD_HELP_TOGGLE"] = "切換用戶介面。"
L["COMMANDS_TEXT"] = "指令"
L["COMMON_TEXT"] = "普通"
L["COPY_TEXT"] = "複製"
