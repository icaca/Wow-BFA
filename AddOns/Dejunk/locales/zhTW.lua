...
L["AUTO_START_DESTROY_TOOLTIP"] = "發現可摧毀物品時自動開始摧毀過程。"
L["AUTO_START_TEXT"] = "自動開始"
...
L["CLASS_TEXT"] = "職業"
L["CMD_ALL_ITEMS_WARNING"] = "|cFFE34F4F警告:|r 此指令如果運行在大量垃圾物品時，可能導致偵率降低甚至斷線。"
L["CMD_HELP_DESTROY"] = "切換摧毀框架。"
L["CMD_HELP_DESTROY_ALL"] = "一次摧毀所有物品。"
...
L["ONLY_DESTROYING_CACHED"] = "某些物品無法檢索。僅摧毀快取的垃圾物品。"
...
L["START_DESTROYING_GAME_VERSION_ERROR"] = "摧毀過程只能在經典版中啟動。"
