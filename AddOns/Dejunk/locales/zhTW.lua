...
L["AUTO_OPEN_DESTROY_SLIDER_LABEL"] = "節省空間"
L["AUTO_OPEN_DESTROY_SLIDER_TOOLTIP"] = "僅當剩餘的行李空間少於設定的數量時，才自動打開“摧毀”框架。|n|n要禁用此功能，請將滑桿設置為％s。"
L["AUTO_OPEN_DESTROY_TEXT"] = "自動開啟"
...
L["ITEM_WINDOW_LEFT_CLICK_TO_DESTROY"] = "左鍵點擊將其摧毀。"
L["ITEM_WINDOW_LEFT_CLICK_TO_SELL"] = "左鍵點擊一個物品來出售。"
L["ITEM_WINDOW_RIGHT_CLICK_TO_EXCLUDE"] = "右鍵點擊一個物品來新增到 %s。"
L["LEFT_CLICK"] = "左鍵點擊"
