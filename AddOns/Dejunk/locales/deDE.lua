...
L["AUTO_OPEN_DESTROY_SLIDER_LABEL"] = "Übriger Taschenplatz"
L["AUTO_OPEN_DESTROY_SLIDER_TOOLTIP"] = "Öffnet das Zerstörenfenster nur automatisch, wenn weniger als eine festgelegte Anzahl von Gepäckräumen übrig ist.|n|nUm dies zu deaktivieren, setzen Sie den Schieberegler auf %s."
L["AUTO_OPEN_DESTROY_TEXT"] = "Automatisch öffnen"
...
L["ITEM_LEVELS_TEXT"] = "Gegenstandslevel"
...
L["SELL_BELOW_AVERAGE_ILVL_TEXT"] = "Unter dem durchschnittlichen Gegenstandslevel"
L["SELL_BELOW_AVERAGE_ILVL_TOOLTIP"] = "Verkaufe Ausrüstung, die eine bestimmte Anzahl von Gegenstandsstufen unter deiner durchschnittlichen Gegenstandsstufe liegt.|n|nKosmetische Gegenstände und Angelruten sind von dieser Einstellung nicht betroffen."
...
L["SOLD_YOUR_JUNK"] = "Dein Plunder wurde für %s verkauft."
