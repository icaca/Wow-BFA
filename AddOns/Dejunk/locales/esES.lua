...
L["AUTO_OPEN_DESTROY_SLIDER_LABEL"] = "Ahorrar espacio"
L["AUTO_OPEN_DESTROY_SLIDER_TOOLTIP"] = "Abrir automáticamente el cuadro Destruir solo cuando queden menos de un número determinado de espacios para bolsas. |n|n Para deshabilitar esto, establezca el control deslizante en %s."
L["AUTO_OPEN_DESTROY_TEXT"] = "Auto abrir"
...
L["ITEM_LEVELS_TEXT"] = "Niveles de objeto"
